...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://test-sso-legrand.azurewebsites.net/simplesaml/',
     ...
     */
    'technicalcontact_name' => 'Nicolas Dissaux',
    'technicalcontact_email' => 'nicolas.dissaux@legrand.com',
    ...
    */
     ...
     */
    'secretsalt' => 'bfsq332ywpv199uifolfs8y51gcx6nkl',
     ...
     */
    'auth.adminpassword' => 'Lespetitspas!',
     ...
     */
     'metadata.sources' => [
          ['type' => 'flatfile'],
          ['type' => 'flatfile', 'directory' => 'metadata/metarefresh-legrand'],
      ],
     /*
